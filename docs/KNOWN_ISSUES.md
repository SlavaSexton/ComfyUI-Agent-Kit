...
**Last updated: 2026-08-01** (statuses are as of this date and move as ComfyUI ships fixes). Current core release:
**v0.29.2** (2026-07-31; v0.29.0 landed 2026-07-29, v0.29.1 in between); current frontend: **v1.49.3** (2026-08-01).
